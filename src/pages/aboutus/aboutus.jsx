  ...
  return (
    <div className="about-us-container">
      <div className="container">
        ...
        <p>Welcome to BattleFiesta, your ultimate destination for competitive gaming!</p>
        <p>At BattleFiesta, we strive to provide an immersive and exhilarating esports experience for Tournamnet creator, players and fans alike. Whether you're a seasoned veteran or a newcomer to the world of competitive gaming, our platform offers something for everyone.</p>
        <h3>Our Mission</h3>
        <p>Our mission is to create a vibrant and inclusive community where gamers from all walks of life can come together to compete, connect, and celebrate their passion for gaming.</p>
