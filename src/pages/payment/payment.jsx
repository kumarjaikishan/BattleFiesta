            ...
            <div className="paymentdetail">
              <form onSubmit={sub}>
                ...
                <div className='full'>
                  ...
                  <div className="under">
                    <span>Coupon</span>
                    <span style={{ color: 'green' }}>- ₹{coupon ? Math.floor((planchoosed.price * coupon) / 100) : 0}.00</span>
                  </div>
                </div>
                <div className='full'>
                  <div className="under">
                    <b><span>Final Price</span></b>
                    <span> <b>₹{planchoosed.price + tax(planchoosed.price) - Math.floor((planchoosed.price * coupon) / 100)}.00</b></span>
                  </div>
                </div>
                <Divider variant="middle" />
              ...
              <Paymentmodal planchoosed={planchoosed} paymodalopen={paymodalopen} setpaymodalopen={setpaymodalopen} />
            </div>
          </div>
        </div>
      </div>
