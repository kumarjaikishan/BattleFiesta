...
`;function Pa({columns:e=[],conditionalRowStyles:t=[],defaultExpanded:n=!1,defaultExpanderDisabled:r=!1,dense:o=!1,expandableIcon:a,expandableRows:i=!1,expandableRowsComponent:d,expandableRowsComponentProps:l,expandableRowsHideExpander:f,expandOnRowClicked:u=!1,expandOnRowDoubleClicked:p=!1,highlightOnHover:m=!1,id:h,expandableInheritConditionalStyles:x,keyField:R,onRowClicked:O=N,onRowDoubleClicked:$=N,onRowMouseEnter:C=N,onRowMouseLeave:b=N,onRowExpandToggled:v=N,onSelectedRow:D=N,pointerOnHover:S=!1,row:g,rowCount:A,rowIndex:U,selectableRowDisabled:Y=null,selectableRows:J=!1,selectableRowsComponent:ae,selectableRowsComponentProps:H,selectableRowsHighlight:ge=!1,selectableRowsSingle:ve=!1,selected:fe,striped:se=!1,draggingColumnId:Ae,onDragStart:K,onDragOver:he,onDragEnd:ce,onDragEnter:M,onDragLeave:Ce}){const[q,de]=s.useState(n);s.useEffect(()=>{de(n)},[n]);const Q=s.useCallback(()=>{de(!q),v(!q,g)},[q,v,g]),me=S||i&&(u||p),ue=s.useCallback(F=>{F.target.getAttribute("data-tag")===Nt&&(O(g,F),!r&&i&&u&&Q())},[r,u,i,Q,O,g]),ee=s.useCallback(F=>{F.target.getAttribute("data-tag")===Nt&&($(g,F),!r&&i&&p&&Q())},[r,p,i,Q,$,g]),Se=s.useCallback(F=>{C(g,F)},[C,g]),X=s.useCallback(F=>{b(g,F)},[b,g]),B=Be(g,R),{conditionalStyle:et,classNames:tt}=hr(g,t,["rdt_TableRow"]),Ot=ge&&fe,Pt=x?et:{},kt=se&&U%2==0;return s.createElement(s.Fragment,null,s.createElement(Oa,{id:`row-${h}`,role:"row",$striped:kt,$highlightOnHover:m,$pointerOnHover:!r&&me,$dense:o,onClick:ue,onDoubleClick:ee,onMouseEnter:Se,onMouseLeave:X,className:tt,$selected:Ot,$conditionalStyle:et},J&&s.createElement(wa,{name:`select-row-${B}`,keyField:R,row:g,rowCount:A,selected:fe,selectableRowsComponent:ae,selectableRowsComponentProps:H,selectableRowDisabled:Y,selectableRowsSingle:ve,onSelectedRow:D}),i&&!f&&s.createElement(Ca,{id:B,expandableIcon:a,expanded:q,row:g,onToggled:Q,disabled:r}),e.map(F=>F.omit?null:s.createElement(ma,{id:`cell-${F.id}-${B}`,key:`cell-${F.id}-${B}`,dataTag:F.ignoreRowClick||F.button?null:Nt,column:F,row:g,rowIndex:U,isDragging:Xe(Ae,F.id),onDragStart:K,onDragOver:he,onDragEnd:ce,onDragEnter:M,onDragLeave:Ce}))),i&&q&&s.createElement(Ra,{key:`expander-${B}`,data:g,extendedRowStyle:Pt,extendedClassNames:tt,ExpanderComponent:d,expanderComponentProps:l}))}const ka=k.span`
	padding: 2px;
	color: inherit;
	flex-grow: 0;
	flex-shrink: 0;
